...
class TelegramDriver extends HttpDriver
{
    ...
    public function buildServicePayload($message, $matchingMessage, $additionalParameters = [])
    {
        ...
        if ($message instanceof Question) {  
            ...
            if ($message->getKeyBoards())  {
                $reply_markup = json_encode([
                    'keyboard'          => $message->getKeyBoards(),
                    'one_time_keyboard' => $message->getOneTimeKeyBoard(),
                    'resize_keyboard'   => true,
                    'is_persistent' => true
                ], true);
            } elseif ($message->needHideKeyboard()) {
                $reply_markup = json_encode(['hide_keyboard' => true, 'selective' => false]);
            }
